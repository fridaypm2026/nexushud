...
- Icon on left + "COLDPIKE" text on right
...
**Text-only wordmark**
- "COLDPIKE" with futuristic gradient
...
// Or as image URL
<img src="/icons/app-icon.svg" alt="Coldpike" />
```
...
```css
:root {
  --coldpike-cyan: #00d4ff;        /* Primary brand color */
  --coldpike-cyan-bright: #00aaff; /* Bright variant */
  --coldpike-cyan-dark: #0088cc;   /* Dark variant */
  --coldpike-dark-bg: #0a0a0f;     /* Dark background */
  --coldpike-white: #ffffff;       /* Highlights/text */
}
```
...
- Title → "Coldpike — AI Command Center"
